...
trait SimpleGen<Arg = ()> {
    ...
    fn resume(self: Pin<&mut Self>, arg: Arg, waker: &SimpleWaker) -> SimpleGenState<Self::Yield, Self::Return>;
}
...
impl SimpleGen for SimpleGenInternal {
    ...
    fn resume(self: Pin<&mut Self>, arg: (), waker: &SimpleWaker) -> SimpleGenState<Self::Yield, Self::Return> {
        ...
        match this {
                ...
                match Pin::new(&mut timer).poll(waker) {
                    Poll::Ready(()) => {
                        *this = SimpleGenInternal::State1 {
                        ...
                        if let SimpleGenInternal::State1 { ref mut vec, ref mut vec_mut_ref, .. } = *this {
                            *vec_mut_ref = vec;
                        }
                    ...
                    Poll::Pending => {
                        *this = SimpleGenInternal::State1 {
                        ...
                        if let SimpleGenInternal::State1 { ref mut vec, ref mut vec_mut_ref, .. } = *this {
                            *vec_mut_ref = vec as *mut Vec<i64>;
                        }
                        SimpleGenState::Yielded("".to_string())
                    }
                }
            }
            SimpleGenInternal::State1 { ref mut vec, ref mut vec_mut_ref, .. } => {
                let vec_mut_ref = unsafe {
                    &mut **vec_mut_ref
                };
                vec_mut_ref.push(4);
                println!("{:?}", vec_mut_ref);
            ...
            SimpleGenInternal::State2 { display } => {
                println!("{}", display);
                println!("test end");
